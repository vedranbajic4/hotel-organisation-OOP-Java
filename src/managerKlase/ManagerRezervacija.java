...
public class ManagerRezervacija {
	...
	public void dodajRezervaciju(TipSobe tipSobe, LocalDate datumDolaska, LocalDate datumOdlaska, LocalDate datumKreiranja) {
		rezervacije.add(new Rezervacija(tipSobe, datumDolaska, datumOdlaska, datumKreiranja));
		kalk.izracunajCenu(rezervacije.get(rezervacije.size()-1));
	}
